...
<body>
	<form action="deleteOk.jsp" method="post" id="form">
		...
		<input type="hidden" name="idx" value="${vo.idx }" />
			...
			<input type="text" class="form-control" id="memo" name="memo"
				placeholder="내용 입력" readonly="readonly" value="${vo.memo }">
		</div>
		<button type="submit" class="btn btn-primary btn-sm">삭제하기</button>
